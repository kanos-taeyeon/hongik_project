...
class FeatureType:
    def __init__(self):
        self.names = {
            ...
            'richheaders': features.RichHeaderInfo(),
            'tls': features.TLSInfo(),
            'assembly': features.AssemblyCodeInfo(),
            'sub_histogram': sub_features.sub_ByteHistogram(),
            'sub_byteentropy': sub_features.sub_ByteEntropyHistogram(),
            'sub_strings': sub_features.sub_StringExtractor(),
        }
