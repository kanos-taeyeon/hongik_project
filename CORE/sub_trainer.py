...
class sub_Gradientboosted(sub_ModelType):
    """
...
class sub_Trainer:
    ...
    def vectorize(self):
        ...
        core.sub_create_vectorized_features(self.jsonlpath, self.outputdir, self.rows, self.features, self.dim)
    ...
    def run(self):
        ...
        # Training
        sub_gradientboostmodel = sub_Gradientboosted(self.output, self.rows, self.dim)
        sub_gradientboostmodel.train()
        sub_gradientboostmodel.save()
